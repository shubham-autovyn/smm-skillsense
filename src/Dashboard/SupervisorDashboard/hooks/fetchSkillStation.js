...
const useFetchSkillStations = () => {
  ...
  const fetchSkillStation = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/fetchL3CompletedStations?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchSkillStations;
