...
const useFetchSkillOperators = () => {
  ...
  const fetchSkillOperators = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/fetchL3CompletedStaffs?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchSkillOperators;
