...
const useFetchNewJoinees = () => {
  ...
  const fetchNewJoinees = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/supervisor/fetchNewJoinees?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchNewJoinees;
