...
const useDailyDeployment = () => {
  ...
  const fetchDeployment = useCallback(
    async (body, supervisorId) => {
      ...
      const params = {
        url: `smm/supervisor/dailyDeployment`,
        config: { signal, headers: { supervisorId: supervisorId } },
        body,
      };
      try {
...
export default useDailyDeployment;
