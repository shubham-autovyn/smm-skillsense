...
const useFetchAreaOperators = () => {
  ...
  const fetchAreaOperators = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/supervisor/fetchAreaOperators?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchAreaOperators;
