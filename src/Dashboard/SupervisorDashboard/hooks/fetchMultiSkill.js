...
const useFetchMultiSkill = () => {
  ...
  const fetchMultiSkill = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/operator/multiskillTrainingPlan?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchMultiSkill;
