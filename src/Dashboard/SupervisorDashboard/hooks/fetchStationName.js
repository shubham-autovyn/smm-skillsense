...
const useFetchStationName = () => {
  ...
  const fetchStationName = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/supervisor/fetchStationName?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchStationName;
