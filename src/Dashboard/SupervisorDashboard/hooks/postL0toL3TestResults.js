...
const useLoToL3TestResult = () => {
  ...
  const fetchLoToL3TestResult = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
  ...
  return {
    dataL0ToL3TestResult: cachedData,
    loading,
    error,
...
export default useLoToL3TestResult;
