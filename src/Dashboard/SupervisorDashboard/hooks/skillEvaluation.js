...
const useSkillEvaluation = () => {
  ...
  const fetchSkillEvaluation = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/staffL4TrainingDetail?${body}`,
        config: { signal },
        body,
      };
      try {
  ...
  return {
    skillEvaluationData: cachedData,
    loading,
    error,
...
export default useSkillEvaluation;
