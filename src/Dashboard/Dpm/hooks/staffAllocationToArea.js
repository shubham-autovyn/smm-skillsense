...
const useFetchStaffAllocationToArea = () => {
  ...
  const fetchStaffAllocation = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/dept/staffAllocationToArea`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchStaffAllocationToArea;
