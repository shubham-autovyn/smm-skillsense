...
const useFetchSaveAllocationPlan = () => {
  ...
  const fetchSaveAllocationPlan = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/plant/saveAllocationPlan`,
        config: { signal },
        body,
      };
      try {
  ...
  return {
    ...
    loading,
    error,
    fetchSaveAllocationPlan,
    removeCache,
    cancelRequest,
  };
};
export default useFetchSaveAllocationPlan;
