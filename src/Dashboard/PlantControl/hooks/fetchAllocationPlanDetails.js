...
const useFetchAllocationPlanDetails = () => {
  ...
  const fetchAllocationPlanDetails = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/plant/fetchAllocationPlanDetails?${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useFetchAllocationPlanDetails;
