...
const useFetchPlannedVsActualJoining = () => {
  ...
  const fetchPlannedVsActualJoining = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/plant/plannedVsActualJoinings`,
        config: { signal },
        body,
      };
      try {
  ...
  return {
    ...
    loading,
    error,
    fetchPlannedVsActualJoining,
    removeCache,
    cancelRequest,
  };
};
export default useFetchPlannedVsActualJoining;
