...
const usePreviousHiring = () => {
  ...
  const fetchPreviousHiring = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/plant/getExportHiringLogs`,
        config: { signal },
        body,
      };
      try {
...
export default usePreviousHiring;
