...
const useStationWiseReports = () => {
  ...
  const fetchStationWise = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/reports/stationwisereports`,
        config: { signal },
        body,
      };
      try {
...
export default useStationWiseReports;
