...
const useGetTestMasterFile = () => {
  ...
  const fetchTestMasterFile = useCallback(
    async (body) => {
      setLoading(true);
      setError(null);
      ...
      const params = {
        url: `smm/qc/fetchTestMasterLogs?qualityInchargeId=${body}`,
        config: { signal },
        body,
      };
      try {
...
export default useGetTestMasterFile;
